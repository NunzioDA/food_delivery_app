...
Per farlo, l'app comunica con il backend - interamente scritto in PHP - tramite richieste http. L'indirizzo del server è specificato nella variabile d'ambiente BACKEND.
